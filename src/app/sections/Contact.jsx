                        ...
                        <div className="contact-box bg-[linear-gradient(135deg,rgba(216,216,216,0.2),transparent)] rounded-[35px] px-[55px] py-[70px] backdrop-blur-2xl backdrop-saturate-100 xl:px-[45px] xl:py-[60px] lg:py-[40px] lg:px-[30px]">
                            ...
                            <form className="row" onSubmit={handleSubmit}>
                                ...
                                {errors.message && errors.error && (
                                    <p className="text-red-800 py-3">{errors.message}</p>
                                )}
                                {errors.error === false && (
                                    <p className="text-green-800 py-3">{errors.message}</p>
                                )}

                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="bg-darkgray text-white !px-[45px] py-[10px] col-auto rounded-[30px] shadow-[0_4px_40px_rgba(0,0,0,0.09)] hover:bg-white hover:text-darkgray transition-all duration-300 active:scale-90 flex items-center"
                                >
                                    Submit
                                    {loading && (
                                        <div role="status">
